  ...
  ru: {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'Persona 1.0 использует ваши данные для предоставления, поддержки, персонализации качества услуг Persona 1.0. Мы можем использовать ваши личные данные для улучшения, разработки и предоставления продуктов и услуг, разработки и обучения моделей искусственного интеллекта (ИИ), разработки, предоставления и персонализации наших услуг, а также для получения информации с помощью ИИ, автоматизированных систем и логических построений, чтобы наши услуги были более актуальными и полезными для вас и других людей',
        ],
        subsections: [
          {
            id: '2.1',
            heading: '2.1. Услуги',
            paragraphs: [
              'Persona 1.0 позволяют вам общаться с другими участниками, находить людей с общими интересами, использовать все возможности приложения и повышать личную эффективность. Возможности  Persona 1.0 позволяют вам оставаться на связи с коллегами, партнерами, клиентами и другими профессиональными контактами, а также получать актуальную информацию о них. Persona 1.0 позволяют вам  осуществлять поиск потенциальных клиентов, заказчиков и других участников для ведения бизнеса. Услуги Persona 1.0 позволяют вам общаться с другими пользователями, планировать и готовиться к встречам с ними',
            ],
          },
          {
            id: '2.3',
            heading: '2.2. Средства связи',
            paragraphs: [
              'Persona 1.0 связывается с вами и реализует функцию обмена сообщениями между пользователями. Для связи с вами будет использоваться электронная почта или мобильный телефон. Persona 1.0 использует данные для совершенствования приложения. Это позволяет предоставлять вам и другим участникам более качественные, интуитивно понятные и персонализированные услуги, а также расширять аудиторию пользователей и  повышать их заинтересованность и помогать связываться друг с другом, находить и использовать  возможности.',
            ],
          },
          {
            id: '2.4',
          ...
          {
            id: '2.6',
            heading: '2.5. Разработка услуг и исследования',
            paragraphs: [
          ...
          {
            id: '2.8',
            heading: '2.7. Статистика, которая не позволяет вас идентифицировать',
            paragraphs: [
          ...
          {
            id: '2.9',
            heading: '2.8. Безопасность и расследования',
            paragraphs: [
      ...
      },
      {
        ...
        subsections: [
          ...
          },
          {
            ...
            paragraphs: [
              'Persona 1.0 может привлекать третьих лиц к оказанию Услуг. Persona 1.0 привлекает третьих лиц для оказания Услуг (например, для обслуживания, анализа, аудита, оплаты, выявления мошенничества, поддержки клиентов, маркетинга и разработки). Такие третьи лица получают доступ к вашим данным (например, к содержанию запроса в службу поддержки клиентов) в той степени, в которой это разумно необходимо для выполнения таких задач от имени Persona 1.0, и принимают на себя обязательство не разглашать эти данные и не использовать их для иных целей. Если вы приобретаете у нас платную услугу, мы можем использовать поставщика платежных услуг, который может отдельно собирать информацию о вас (например, для предотвращения мошенничества или для выполнения юридических обязательств).',
            ],
          },
          {
            id: '3.6',
        ...
        subsections: [
          {
            ...
            paragraphs: [
              'Persona 1.0 хранит большую часть ваших персональных данных до тех пор, пока ваша учетная запись открыта. Как правило, Persona 1.0 сохраняет ваши персональные данные до тех пор, пока вы не закроете вашу учетную запись. Вы можете просматривать ваши персональные данные или удалять их.  Информация, которой вы поделились с другими пользователями будет доступна для просмотра даже после закрытия вашей учетной записи. Кроме того, Persona 1.0 не может контролировать данные, которые другие пользователи скопировали из приложения Persona 1.0.',
            ],
          },
          {
            id: '4.2',
        ...
        subsections: [
          {
            ...
            paragraphs: [
              'Persona 1.0 не может гарантировать безопасность какой-либо информации, передаваемой вами в Persona 1.0. Мы не даем никаких гарантий, что данные не будут просмотрены, раскрыты, изменены или уничтожены вследствие отказа или взлома каких-либо физических, технических или административных мер защиты. Persona собирает и обрабатывает персональные данные о вас при наличии законных оснований. К законным основаниям относятся согласие (когда вы дали соответствующее согласие) и другие законные основания.',
