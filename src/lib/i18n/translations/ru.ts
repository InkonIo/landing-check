...
export const ru: TranslationSchema = {
  ...
  hero: {
    title: 'Persona 1.0',
    description: 'Добро пожаловать в проект всех тех, кто себя любит, уважает и ценит... все в наших руках и в наших силах, результат нашей жизни это отражение нашей работы над самим собой....мы сами делаем себя.... каждый человек автор своей жизни....Победишь себя, победишь весь мир! Дорогой друг! Вступай в сообщество «Persona»! Пройди регистрацию она БЕСПЛАТНАЯ и используй все возможности приложения в свою пользу!... А что делать дальше это ТВОИ ВЫБОР! Желаю удачи!!!',
