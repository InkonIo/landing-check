...
export const kz: TranslationSchema = {
  ...
  hero: {
    title: 'Persona 1.0',
    description: 'Өзін сүйетін, құрметтейтін және бағалайтын барлық адамдардың жобасына қош келдіңіз... бәрі біздің қолымызда және біздің қолымыздан келеді, өміріміздің нәтижесі — өзіміз үстінде жасаған жұмысымыздың көрінісі.... біз өзімізді өзіміз жасаймыз.... әр адам — өз өмірінің авторы.... Өзіңді жеңсең, бүкіл әлемді жеңесің! Қымбатты дос! «Persona» қоғамдастығына қосыл! Тіркеуден өт, ол ТЕГІН, және қосымшаның барлық мүмкіндіктерін өз пайдаңа қолдан!... Ал бұдан әрі не істеу — бұл СЕНІҢ ТАҢДАУЫҢ! Сәттілік тілеймін!!!',
    downloadIn: 'Жүктеу',
